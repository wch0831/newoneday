...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.jsp"><b>T<br>H<br>E</b>Big Store<span>The Best Supermarket</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
									...
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												...
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Water & Beverages</a></li>
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Fruits & Vegetables</a></li>
												<li><a href="kitchen.jsp"> <i class="fa fa-angle-right" aria-hidden="true"></i>Staples</a></li>
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Branded Food</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Breakfast &amp; Cereal</a></li>
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Snacks</a></li>
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Spices</a></li>
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Biscuit &amp; Cookie</a></li>
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Sweets</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Pickle & Condiment</a></li>
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Instant Food</a></li>
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Dry Fruit</a></li>
												<li><a href="kitchen.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Tea &amp; Coffee</a></li>
										
											</ul>
										</div>
										<div class="col-sm-3 w3l">
											<a href="kitchen.jsp"><img src="images/me.png" class="img-responsive" alt=""></a>
										</div>
							...
							<li class="dropdown active active1">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i> Ayurvedic </a></li>
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Baby Care</a></li>
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Cosmetics</a></li>
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Deo & Purfumes</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="care.jsp"> <i class="fa fa-angle-right" aria-hidden="true"></i>Hair Care </a></li>
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Oral Care</a></li>
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Personal Hygiene</a></li>
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Skin care</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i> Fashion Accessories </a></li>
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Grooming Tools</a></li>
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Shaving Need</a></li>
												<li><a href="care.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Sanitary Needs</a></li>
										
											</ul>
										</div>
										<div class="col-sm-3 w3l">
											<a href="care.jsp"><img src="images/me1.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Cleaning Accessories</a></li>
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>CookWear</a></li>
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Detergents</a></li>
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Gardening Needs</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Kitchen & Dining</a></li>
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>KitchenWear</a></li>
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Pet Care</a></li>
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Plastic Wear</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Pooja Needs</a></li>
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Serveware</a></li>
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Safety Accessories</a></li>
												<li><a href="hold.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Festive Decoratives </a></li>
										
											</ul>
										</div>
										<div class="col-sm-3 w3l">
											<a href="hold.jsp"><img src="images/me2.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
							...
							<li><a href="codes.jsp" class="hyper"> <span>Codes</span></a></li>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="care.jsp"><img class="first-slide" src="images/ba1.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
          <a href="kitchen.jsp"><img class="second-slide " src="images/ba.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
          <a href="hold.jsp"><img class="third-slide " src="images/ba2.jpg" alt="Third slide"></a>
				...
				<div class=" con-w3l agileinf">
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Baby Oil</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Soap</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Hair Gel</a>(100 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Lotion </a>(100 g)</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal5" class="offer-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Shower Gel</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$7.00</label><em class="item_price">$6.00</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Hair Color</a>(250 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$5.00</label><em class="item_price">$4.50</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp"> Wipes</a>(300 kg)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Essential Oils</a>(200 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$1.00</label><em class="item_price">$0.80</em></p>
											  <div class="block">
								...
								<a href="#" data-toggle="modal" data-target="#myModal9" class="offer-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Cream</a>(150 g)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$7.00</label><em class="item_price">$6.00</em></p>
											  <div class="block">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Baby Care</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$4.00</label><em class="item_price">$3.50</em></p>
											  <div class="block">
	...
	<div class="container">
		...
		<div class="clearfix"></div>
			<div class="footer-bottom">
				<h2 ><a href="index.jsp"><b>T<br>H<br>E</b>Big Store<span>The Best Supermarket</span></a></h2>
